...
redirect_from:
  - "/wiki/creative/webnovel-writer-long-context/"
...
*Source: [lingfengQAQ/webnovel-writer GitHub](https://github.com/lingfengQAQ/webnovel-writer). Discovery note: @今天学点啥? on Douyin.*
...
These are the same principles behind [harness engineering](/learnAIDoc/wiki/harness-engineering-agents/) and [Karpathy's LLM Knowledge Bases](/learnAIDoc/wiki/karpathy-llm-knowledge-bases/). The web novel is just a concrete application of the general pattern.
