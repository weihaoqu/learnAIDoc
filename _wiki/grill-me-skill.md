...
related: ["Matt Pocock's Skills — Claude Code for Real Engineers", "Karpathy Skills — Four Rules That Fix LLM Coding's Worst Habits", "Anthropic Skills — Thariq's Framework for Reusable Capabilities", "Claude Code Context Management & CLAUDE.md — From Pitfalls to Infrastructure", "Domain Experts Shipping Products with Claude Code — Stories from the Trenches"]
icon: "🔥"
...
- **Companion deep-dives** in this wiki:
  ...
  - [Anthropic Skills — Thariq's Framework for Reusable Capabilities](/learnAIDoc/wiki/anthropic-skills-thariq-framework/) — the broader skills movement
