...
related: ["SkillsMP — Map the Agent Skills Ecosystem Before You Install", "Addy Osmani's agent-skills — Senior Engineering Practices as SKILL.md Files", "Matt Pocock's Skills — Claude Code for Real Engineers", "Karpathy Skills — Four Rules That Fix LLM Coding's Worst Habits", "kepano/obsidian-skills — Agent Skills That Let AI Edit Your Vault", "grill-me — When AI Interviews You Before Writing Code", "Paper-Code Joint Analysis & Contract-Driven Skill Design"]
icon: "🧩"
