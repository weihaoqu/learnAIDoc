...
related: ["Karpathy's LLM Knowledge Bases — Building a Personal Wiki with AI", "Claude Code as Research Infrastructure — From Chatbot to AI Research Team", "alphaXiv MCP — Semantic ArXiv Search Directly in Claude Code", "Paper-Code Joint Analysis & Contract-Driven Skill Design"]
icon: "📚"
