...
related: ["Claude Drafts, Codex Gates — An Interleaved Two-Model Review Loop for Hard Work", "Cross-Model Code Review — Why Claude Can't Catch Its Own Bugs", "Claude Code as Research Infrastructure — From Chatbot to AI Research Team", "Harness Engineering — The Real Bottleneck Isn't the Model", "Codex Orange Book — 花叔's Bilingual Codex Reference", "progress.md Handoff — A Scripted Codex ⇄ Claude Code Workflow"]
icon: "🔬"
