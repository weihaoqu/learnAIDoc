...
1. **Focus LAI on teacher empowerment**, not student automation
2. **Build the "factory" tools** — templates, skills, workflows that teachers can use to create custom materials
3. **The wiki itself** is an example: a teacher (Q) using AI to build a knowledge resource that students can learn from
4. **Train the trainers first** — AI literacy for faculty is more impactful than AI literacy for students
