...
related: ["GPT Image 2 水墨风 Slide Prompt — Structured Template for Ink-Wash Style Slides", "ImageLens — Chrome Extension That Extracts AI-Editable Prompts from Any Web Image", "Agents with Taste — Encoding Design Judgment as Skill Files", "Prompt Master — Write Accurate Prompts for Any AI Tool, Zero Waste"]
icon: "🖼️"
