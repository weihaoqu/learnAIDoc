---
title: "AI Learning Roadmap 2026 — Best Courses, Certs & YouTube Channels"
date: 2026-03-31
category: Learning Resources
redirect_from:
  - "/wiki/ai education/ai-learning-courses-youtube-2026/"
...
|---|---|---|---|---|
| Generative AI Learning Path | Google Cloud Skills Boost | Self-paced modules | Free | [cloudskillsboost.google/paths/118](https://www.cloudskillsboost.google/paths/118) |
| AI Fundamentals (AI-900) | Microsoft Learn | Self-paced + cert exam | Free materials, paid exam (~$165) | [learn.microsoft.com](https://learn.microsoft.com) |
| AI Engineering Professional Certificate | IBM (via Coursera) | Video lectures + projects | Free audit (paid for cert) | [coursera.org](https://www.coursera.org) |
| Short Courses (Agents, RAG, Fine-tuning, Prompt Engineering) | DeepLearning.AI (Andrew Ng) | 1–2 hour mini-courses | Free | [deeplearning.ai/short-courses](https://www.deeplearning.ai/short-courses/) |
| Prompt Engineering Guide | Anthropic | Interactive tutorial + docs | Free | [anthropic.skilljar.com](https://anthropic.skilljar.com) / [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) |
| CS50's Introduction to AI with Python | Harvard (via edX) | University lectures + problem sets | Free | [cs50.harvard.edu/ai](https://cs50.harvard.edu/ai) |
