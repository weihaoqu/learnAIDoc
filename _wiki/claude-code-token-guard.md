...
related: ["Claude Code Token Costs: The Hidden Tax and How rtk Cuts It by 80%", "Claude Code Session Stats & Usage", "Claude Code Auto Mode — The Middle Path for Permissions", "Claude Code Hooks", "gnhf — Good Night, Have Fun: Run AI Agents While You Sleep"]
icon: "🛡️"
