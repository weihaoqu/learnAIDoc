---
title: "AI Ethics in College: Stop Asking \"Did Students Use AI?\" Ask Whether They Learned"
date: 2026-08-28
category: AI for Teaching
tags: [ai-ethics, ai-education, ai-literacy, responsible-ai, fairness, privacy, accountability, assessment, college, teaching]
related: ["AI Ethics — From Principles to Power Structures", "AI Education Search-Space Design — Make Students Wider Before Faster", "Learning in the AI Era: Amplify Your Thinking, Don't Outsource It", "What Researchers Should (and Shouldn't) Use LLMs For", "Anti-AI Exam Designer — A Claude Code Skill for AI-Resistant Exams"]
icon: "🎓"
image: "/assets/images/ai-ethics-college-policy.png"
---
...
*Source basis: [Jobin, Ienca, and Vayena, "The global landscape of AI ethics guidelines" (Nature Machine Intelligence, 2019)](https://www.nature.com/articles/s42256-019-0088-2); [Corrêa et al., "Worldwide AI Ethics: A review of 200 guidelines and recommendations for AI governance" (Patterns, 2023)](https://doi.org/10.1016/j.patter.2023.100857), with [project page](https://nkluge-correa.github.io/worldwide_AI-ethics/); [Giarmoleo et al., "What ethics can say on artificial intelligence: Insights from a systematic literature review" (Business and Society Review, 2024)](https://doi.org/10.1111/basr.12336); [Groen, Sharon, and Becker, "An overview of AI ethics: moral concerns through the lens of principles, lived realities and power structures" (AI and Ethics, 2026)](https://link.springer.com/article/10.1007/s43681-025-00955-7). This page is an educational synthesis for college AI-use policy. It does not claim that the four papers share one unified higher-education framework. Education-specific support also comes from [UNESCO's 2023 guidance for generative AI in education and research](https://www.unesco.org/en/articles/guidance-generative-ai-education-and-research) and the [U.S. Department of Education's 2023 report on AI and the future of teaching and learning](https://www.ed.gov/sites/ed/files/documents/ai-report/ai-report.pdf).*

## Opening Case: The Student-AI Assignment

A professor assigns a short analytical report. The syllabus says: "Use AI responsibly and disclose any AI assistance." It does not define responsible use, does not list approved tools, and does not explain what can or cannot be uploaded to a chatbot.
...
This case shows why "AI or no AI" is the wrong question. The real questions are:
...
|---|---|---|---|
| ["The global landscape of AI ethics guidelines"](https://www.nature.com/articles/s42256-019-0088-2) | Anna Jobin, Marcello Ienca, Effy Vayena | Review of 84 AI ethics guideline documents | AI ethics principles such as transparency, fairness, non-maleficence, responsibility, and privacy are common, but the same words are interpreted differently across documents. |
| ["Worldwide AI Ethics"](https://doi.org/10.1016/j.patter.2023.100857) | Nicholas Kluge Corrêa et al. | Review of 200 AI governance guidelines and recommendations | AI governance documents repeat many principles, but most are soft-law recommendations; practical implementation and enforcement remain thin. |
| ["What ethics can say on artificial intelligence"](https://doi.org/10.1111/basr.12336) | Gaetano Giarmoleo, Ignacio Ferrero, Marta Rocchi, Massimiliano Pellegrini | Systematic literature review of 309 academic articles | AI ethics research discusses both design problems and human-AI interaction problems; proposed solutions split between act-centered rules and agent-centered human formation. |
| ["An overview of AI ethics"](https://link.springer.com/article/10.1007/s43681-025-00955-7) | Elizabeth M. Groen, Tamar Sharon, Marcel Becker | Narrative overview | AI ethics needs three lenses: principles, lived realities, and power structures. Principles alone miss how AI changes real people, institutions, and control. |
...
But the paper also shows the core weakness of principle lists: agreement on vocabulary does not produce agreement on practice. "Use AI responsibly" sounds clear until students, teachers, and administrators define responsibility differently.
...
### 2. Corrêa et al.: Governance Needs Teeth

Corrêa et al. broaden the view by comparing 200 AI governance documents. The useful lesson for universities is that written principles often remain soft unless they become concrete obligations.

In a course policy, that means "responsible AI use" must become operational:
...
|---|---|---|
| Allowed | Use AI to discuss ideas, clarify concepts, plan structure, question assumptions, get feedback, and then write or build in the student's own words. | Allowed with disclosure when the assignment permits AI. |
...
Privacy is not only about the student using AI. One student's upload can expose another student's work, a teacher's feedback, or unpublished course material.
...
The accountability failure in many universities is that the policy says "students are responsible" while the institution has not defined the rule, provided equitable access, taught the skill, or redesigned assessment.

Appeals matter because a fair AI policy cannot depend only on suspicion. If a student's work is challenged, the acceptable evidence should be named in advance: disclosure appendix, draft history, source checklist, oral defense, presentation answers, in-class follow-up, or a related no-network task. AI detectors should not be treated as sole proof; [TEQSA's academic-integrity guidance](https://www.teqsa.gov.au/guides-resources/protecting-academic-integrity/academic-integrity-toolkit/risks-academic-integrity-ai/detecting-plagiarism-ai-generated-text-student-assessments-and-securing-take-home-written-assessments) similarly emphasizes that detector scores alone are insufficient and require additional evidence.
...
This is why "ban AI" is not automatically fair. As AI-supported work becomes normal elsewhere, students in a ban-only environment may become less prepared. But "allow AI" is also not automatically fair if access, disclosure, privacy, and assessment are unmanaged.
...
1. Final report.
2. AI disclosure appendix.
3. Three prompt excerpts or prompt summaries.
4. Source verification checklist.
5. One-page reflection: "Where did AI strengthen my thinking, and where did it tempt me to stop thinking?"
...
1. Which part of your work was easier because of AI?
2. Which part became more dangerous because AI sounded confident?
3. Did AI give you an idea you would not have found alone?
4. Did you reject or correct anything AI suggested?
5. Could you defend the final report without AI open?
6. Did you upload any material that belonged to your teacher, classmates, or institution?
7. If another student had no access to your AI tool, would the assignment still be fair?
...
| 9 | What did the four papers say? | Jobin maps common principles; Corrêa maps governance documents; Giarmoleo maps concerns and act/agent solutions; Groen adds principles, lived realities, and power structures. |
| 10 | What does Jobin/Correa teach before answering policy questions? | Their work shows that "responsible AI" is too vague unless the institution defines duties, disclosure, enforcement, and implementation. |
| 11 | Why is "responsible AI use" unclear? | Students and teachers can define responsibility differently: using AI to learn may be responsible, while using AI to complete homework without understanding is not. |
...
| 14 | What are Giarmoleo's act-centered and agent-centered responses? | Act-centered means rules, standards, policies, and procedures. Agent-centered means forming people who can judge cases responsibly. A college needs both. |
| 15 | What is the five-sentence argument? | Current AI policy often focuses too much on policing cheating. This is too narrow because it does not teach valid AI use. Jobin and Corrêa show vague principles need concrete obligations. Giarmoleo shows rules and judgment must work together. Groen shows principles must be tested against lived reality and power. |
...
| 25 | What title captures the argument? | "Stop Asking 'Did Students Use AI?' Ask Whether They Learned." |
...
| Format | Link | Notes |
|---|---|---|
| PDF | [ai-ethics-college-policy.pdf](/learnAIDoc/assets/decks/ai-ethics-college-policy/ai-ethics-college-policy.pdf) | Best for reading and classroom sharing. |
| PPTX | [ai-ethics-college-policy.pptx](/learnAIDoc/assets/decks/ai-ethics-college-policy/ai-ethics-college-policy.pptx) | Image-based slides with prompt notes, not fully editable text/shapes. |

## Slide Gallery

<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:18px;margin:1.5rem 0;">
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/01-slide-cover.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/01-slide-cover.png" alt="Slide 1: AI ethics in college assignments" style="width:100%;border-radius:8px;"></a>
    <figcaption>1. AI ethics in college assignments</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/02-slide-opening-case.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/02-slide-opening-case.png" alt="Slide 2: The student-AI assignment case" style="width:100%;border-radius:8px;"></a>
    <figcaption>2. The student-AI assignment case</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/03-slide-wrong-question.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/03-slide-wrong-question.png" alt="Slide 3: The wrong question is did students use AI" style="width:100%;border-radius:8px;"></a>
    <figcaption>3. Stop asking only whether AI was used</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/04-slide-four-paper-map.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/04-slide-four-paper-map.png" alt="Slide 4: Four paper map" style="width:100%;border-radius:8px;"></a>
    <figcaption>4. Four-paper map</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/05-slide-principles-not-policy.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/05-slide-principles-not-policy.png" alt="Slide 5: Principles are not policies" style="width:100%;border-radius:8px;"></a>
    <figcaption>5. Principles are not policies</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/06-slide-governance-needs-teeth.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/06-slide-governance-needs-teeth.png" alt="Slide 6: Governance needs teeth" style="width:100%;border-radius:8px;"></a>
    <figcaption>6. Governance needs teeth</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/07-slide-rules-plus-judgment.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/07-slide-rules-plus-judgment.png" alt="Slide 7: Rules plus judgment" style="width:100%;border-radius:8px;"></a>
    <figcaption>7. Rules plus judgment</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/08-slide-three-lenses.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/08-slide-three-lenses.png" alt="Slide 8: Principles lived realities and power structures" style="width:100%;border-radius:8px;"></a>
    <figcaption>8. Principles, lived realities, power</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/09-slide-use-boundary.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/09-slide-use-boundary.png" alt="Slide 9: Allowed borderline prohibited AI use" style="width:100%;border-radius:8px;"></a>
    <figcaption>9. Allowed, borderline, prohibited</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/10-slide-four-part-policy.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/10-slide-four-part-policy.png" alt="Slide 10: Allow disclose protect assess" style="width:100%;border-radius:8px;"></a>
    <figcaption>10. Allow, disclose, protect, assess</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/11-slide-assessment-redesign.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/11-slide-assessment-redesign.png" alt="Slide 11: Assessment redesign" style="width:100%;border-radius:8px;"></a>
    <figcaption>11. Grade evidence of understanding</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/12-slide-fairness-and-power.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/12-slide-fairness-and-power.png" alt="Slide 12: Fairness and power" style="width:100%;border-radius:8px;"></a>
    <figcaption>12. Fairness and power</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/13-slide-homework.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/13-slide-homework.png" alt="Slide 13: Homework for students" style="width:100%;border-radius:8px;"></a>
    <figcaption>13. Homework for students</figcaption>
  </figure>
  <figure>
    <a href="/learnAIDoc/assets/images/ai-ethics-college-policy/14-slide-closing.png"><img src="/learnAIDoc/assets/images/ai-ethics-college-policy/14-slide-closing.png" alt="Slide 14: Use AI to think better" style="width:100%;border-radius:8px;"></a>
    <figcaption>14. Use AI to think better, not to stop thinking</figcaption>
  </figure>
</div>

## References

- Jobin, A., Ienca, M., & Vayena, E. (2019). ["The global landscape of AI ethics guidelines."](https://www.nature.com/articles/s42256-019-0088-2) *Nature Machine Intelligence*, 1, 389-399. DOI: 10.1038/s42256-019-0088-2.
- Corrêa, N. K., et al. (2023). ["Worldwide AI Ethics: A review of 200 guidelines and recommendations for AI governance."](https://doi.org/10.1016/j.patter.2023.100857) *Patterns*, 4(10), 100857. DOI: 10.1016/j.patter.2023.100857. [Project page](https://nkluge-correa.github.io/worldwide_AI-ethics/).
- Giarmoleo, G., Ferrero, I., Rocchi, M., & Pellegrini, M. M. (2024). ["What ethics can say on artificial intelligence: Insights from a systematic literature review."](https://doi.org/10.1111/basr.12336) *Business and Society Review*. DOI: 10.1111/basr.12336.
- Groen, E. M., Sharon, T., & Becker, M. (2026). ["An overview of AI ethics: moral concerns through the lens of principles, lived realities and power structures."](https://link.springer.com/article/10.1007/s43681-025-00955-7) *AI and Ethics*, 6, Article 121. DOI: 10.1007/s43681-025-00955-7.
...
- Tertiary Education Quality and Standards Agency. (2026). ["Detecting plagiarism of AI-generated text in student assessments and securing take-home written assessments."](https://www.teqsa.gov.au/guides-resources/protecting-academic-integrity/academic-integrity-toolkit/risks-academic-integrity-ai/detecting-plagiarism-ai-generated-text-student-assessments-and-securing-take-home-written-assessments)

## Related Reading

- [AI Ethics - From Principles to Power Structures](/learnAIDoc/wiki/ai-ethics-from-principles-to-power/)
- [AI Education Search-Space Design - Make Students Wider Before Faster](/learnAIDoc/wiki/ai-education-search-space-design/)
- [Learning in the AI Era: Amplify Your Thinking, Don't Outsource It](/learnAIDoc/wiki/learning-effectively-ai-era/)
- [What Researchers Should and Shouldn't Use LLMs For](/learnAIDoc/wiki/researcher-llm-use-boundaries/)
- [Anti-AI Exam Designer - A Claude Code Skill for AI-Resistant Exams](/learnAIDoc/wiki/anti-ai-exam-skill/)
