...
related: ["Addy Osmani's agent-skills — Senior Engineering Practices as SKILL.md Files", "Agents with Taste — Encoding Design Judgment as Skill Files", "grill-me — When AI Interviews You Before Writing Code", "Personal AI Skill Cheat Sheet — When to Use Each Skill"]
icon: "🐷"
