...
MAPPING = {
    ...
    "claude-code-session-stats": "Claude Code Basics",
    "claude-code-statusline": "Claude Code Basics",
    "claude-code-rewind": "Claude Code Basics",
    "claude-howto-learning-path": "Claude Code Basics",
    "claude-code-best-plugins": "Claude Code Basics",
    ...
    "claude-code-power-tips": "Claude Code Engineering",
    ...
    "baoyu-youtube-transcript-skill": "Skills & Plugins",
    ...
    "last30days-skill": "Skills & Plugins",
    ...
    "skill-seekers-guide": "Skills & Plugins",
    ...
    "sentrysearch-video-search": "Skills & Plugins",
    ...
    "awesome-design-md": "Skills & Plugins",
    ...
    "type4me-local-voice-input": "Skills & Plugins",
    ...
    "agent-framework-weekly-hot-four": "AI for Research",
    ...
    "ai-research-thinking-toolkit": "AI for Research",
    ...
    "ai-impacts-skill-formation": "AI for Teaching",
    ...
    "ai-learning-tools": "Learning Resources",
    ...
    "voice-pro-ai-dubbing-translation": "Creative & Media",
    "moneyprinter-turbo-video-automation": "Creative & Media",
    "seedance-2-ai-video": "Creative & Media",
