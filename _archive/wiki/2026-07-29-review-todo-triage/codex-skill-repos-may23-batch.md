...
related: ["CodeGraph: Local Code Knowledge Graph that Cuts Token Usage", "academic-research-skills — Imbad0202's 4-Skill Claude Code Pipeline for Academic Research", "How Anthropic Uses Skills — Thariq's 9-Category Framework & the Gotchas Pattern", "Personal AI Skill Cheat Sheet — When to Use Each Skill"]
icon: "📚"
