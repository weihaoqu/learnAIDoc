...
related: ["HTML PPT Studio — AI-Powered Presentation Skill for Claude Code", "GPT Image 2 水墨风 Slide Prompt — Structured Template for Ink-Wash Style Slides", "open-slide — The Slide Framework Built for AI Coding Agents", "Claude Code Plugins & Marketplace", "AI Slide Generation with Claude Code — Tool Comparison & Guide"]
icon: "📊"
